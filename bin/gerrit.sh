...
##################################################
if test -f /home/labcoat/gerrit/gerritcodereview ; then 
  . /home/labcoat/gerrit/gerritcodereview
fi
...
case "$ACTION" in
  start)
    ...
    if test 1 = "$NO_START" ; then 
      echo "Not starting gerrit - NO_START=1 in /home/labcoat/gerrit/gerritcodereview"
      exit 0
    fi
